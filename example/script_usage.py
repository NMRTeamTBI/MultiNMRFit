...
#         build_model(signals, available_models, offset=None)
...
#         set_offset(offset)
#             Update the value of the offset (in 'offset' and 'params' attributes).
#         simulate(params=None)
#             Simulate spectrum. If params is None, initial values (in 'params' attribute) 
#             are used for simulation.
#             Returns a list of simulated intensities.
#         fit(method="L-BFGS-B")
#             Fit experimental spectrum using the 'L-BFGS-B' or 'differential_evolution' 
...
#         integrate(params=None, bounds=[-100.0, 300.0])
