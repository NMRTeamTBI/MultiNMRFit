# -*- coding: utf-8 -*-
#
# MultiNMRFit documentation build configuration file, created by
...
# built documents.
#
import multinmrfit  # NB: the *installed* version that is used in the notebooks

full_version = multinmrfit.__version__  # x.y.z
...
htmlhelp_basename = 'MultiNMRFitdoc'
...
texinfo_documents = [
  ('index', 'MultiNMRFit', u'MultiNMRFit Documentation',
   u'Cyril Charlier, Pierre Millard', 'MultiNMRFit', 'NMR 1H 1D spectral analysis',
   'Miscellaneous'),
]
